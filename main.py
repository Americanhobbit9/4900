...
def main_menu():
    ...
    while True: 
        ...
        # Get mouse position & update display
...
def pause_menu():
    ...
    while paused:
        for event in pygame.event.get(): 
            ...
            unpause_dims = get_button_dims(unpause_button, 0)
            quit2main_dims = get_button_dims(quit2main_button, 70)
...
def level1():
    ...
    while playing:
        ...
        if level.dead == True:
            ...
            game_over = pygame.image.load("imgs/game_over.png"). convert()
